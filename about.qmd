...
To run this yourself, go to <https://github.com/bomeara/nursinghomecovid>, clone the repository, and then source `run.R` to run quarto to make the site. Make sure you have the packages listed above installed.