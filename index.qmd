...
* **`r round(100*sum(covid_presentation_data$'Beds Occupied' * covid_presentation_data$'Current Residents Up to Date with Covid Vaccines', na.rm=TRUE)/sum(covid_presentation_data$'Beds Occupied', na.rm=TRUE), 1)`% of nursing home beds are occupied by residents who are fully up to date on covid vaccines**.
