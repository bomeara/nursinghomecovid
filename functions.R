...
make_presentation_data <- function(clean_data) {
	...
	presentation_data$PopupLabel <- paste0(presentation_data$Facility, '<br />', presentation_data$Address, ", ", presentation_data$City, ", ", presentation_data$State, "<br />", "<br />", "Current Healthcare Personnel Up to Date with Covid Vaccines: ", 100*presentation_data$`Current Healthcare Personnel Up to Date with Covid Vaccines`, "%", "<br />", "Current Healthcare Personnel Ever Vaccinated for Covid: ", 100*presentation_data$`Current Healthcare Personnel Ever Vaccinated for Covid`, "%", "<br />", "Current Residents Up to Date with Covid Vaccines: ", 100*presentation_data$`Current Residents Up to Date with Covid Vaccines`, "%", "<br />",  "Residents Weekly Confirmed Covid: ", presentation_data$`Residents Weekly Confirmed Covid`, "<br />", "Residents Weekly All Deaths: ", presentation_data$`Residents Weekly All Deaths`, "<br />", "Residents Total All Deaths: ", presentation_data$`Residents Total All Deaths`, "<br />", "Residents Weekly Covid Deaths: ", presentation_data$`Residents Weekly Covid Deaths`, "<br />", "Residents Total Covid Deaths: ", presentation_data$`Residents Total Covid Deaths`, "<br />", "Beds All: ", presentation_data$`Beds All`, "<br />", "Beds Occupied: ", presentation_data$`Beds Occupied`, "<br />", "Staff Weekly Confirmed Covid: ", presentation_data$`Staff Weekly Confirmed Covid`, "<br />", "Weekly Resident Covid Cases Per 1,000 Residents: ", presentation_data$`Weekly Resident Covid Cases Per 1,000 Residents`, "<br />", "Weekly Resident Covid Deaths Per 1,000 Residents: ", presentation_data$`Weekly Resident Covid Deaths Per 1,000 Residents`, "<br />", "Total Resident Covid Deaths Per 1,000 Residents: ", presentation_data$`Total Resident Covid Deaths Per 1,000 Residents`, "<br />", "Week Ending: ", presentation_data$`Week Ending`)
